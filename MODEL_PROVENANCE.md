...
| BiRefNet general Swin-Tiny `BiRefNet-general-bb_swin_v1_tiny-epoch_232.onnx` | M20 Subject soft mask; Background is its exact complement | [`ZhengPeng7/BiRefNet`](https://github.com/ZhengPeng7/BiRefNet) tag `v1`, commit `a0cf9925880620000aa2d1948d61bf659ddfdfaa`; [official release asset](https://github.com/ZhengPeng7/BiRefNet/releases/download/v1/BiRefNet-general-bb_swin_v1_tiny-epoch_232.onnx), asset id `186739942`, created `2024-08-18` | `5600024376f572a557870a5eb0afb1e5961636bef4e1e22132025467d0f03333`; 224,005,088 bytes | MIT, copyright 2024 ZhengPeng. **APPROVED FOR REDISTRIBUTION** with the exact upstream license retained at `licenses/models/BiRefNet-LICENSE.txt`. | The weight remains Git-ignored. The Windows rc.2 release job downloads only the pinned official asset, verifies size/SHA-256 before packaging, and installs it under `models/local/`. Runtime never downloads, uploads or substitutes a model. |
